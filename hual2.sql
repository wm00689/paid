...
INSERT INTO `article` VALUES ('28', '15', null, '1', 'UC九游完成阿里手游业务整合 将发布新战略', null, '<p>越位<br/>　　?1.凡进攻队员较球更接近于对方球门线者，即为处于越位位置。下列情况除外：　<br/>　　·a.该队员在本方半场内。<br/>　　·b.至少有对方队员两人比该队员更接近于对方的球门线。<br/>　　?2.当队员踢或触及球的一瞬间，同队队员处于越位位置时，裁判员认为该队员有下列行为，则应判为越位：<br/>　　·a.在干扰比赛或干扰对方；<br/>　　·b.企图从越位位置获得利益。<br/>　　?3.下列情况，队员不应被判为越位：<br/>　　·a.队员仅仅处在越位位置；<br/>　　·b.队员直接接得球门球、角球或界外掷球。<br/>　</p>', '0', '', '', '', '', null, '1427380010', '1427447726');
